const require_Tokenizer = require("./Tokenizer.js");
...
var Parser = class {
	...
	*/
	...
	constructor(cbs, options = {}) {
		...
		this.tokenizer = new (options.Tokenizer ?? require_Tokenizer.default)(this.options, this);
	...
	*/
	onattribend(quote, endIndex) {
		this.endIndex = endIndex;
		this.cbs.onattribute?.(this.attribname, this.attribvalue, quote === require_Tokenizer.QuoteType.Double ? "\"" : quote === require_Tokenizer.QuoteType.Single ? "'" : quote === require_Tokenizer.QuoteType.NoValue ? void 0 : null);
