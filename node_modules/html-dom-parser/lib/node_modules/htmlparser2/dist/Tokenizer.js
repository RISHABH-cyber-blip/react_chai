const require_decode_data_html = require("../../entities/dist/generated/decode-data-html.js");
const require_decode_data_xml = require("../../entities/dist/generated/decode-data-xml.js");
const require_decode = require("../../entities/dist/decode.js");
...
var Tokenizer = class {
	...
	constructor({ xmlMode = false, decodeEntities = true, recognizeSelfClosing = xmlMode }, cbs) {
		...
		this.entityDecoder = new require_decode.EntityDecoder(xmlMode ? require_decode_data_xml.xmlDecodeTree : require_decode_data_html.htmlDecodeTree, (cp, consumed) => this.emitCodePoint(cp, consumed));
	}
	reset() {
	...
	*/
	...
	startEntity() {
		...
		this.entityDecoder.startEntity(this.xmlMode ? require_decode.DecodingMode.Strict : this.baseState === State.Text || this.baseState === State.InSpecialTag ? require_decode.DecodingMode.Legacy : require_decode.DecodingMode.Attribute);
	}
	stateInEntity() {
